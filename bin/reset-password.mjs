 ...
 *
 * Resets the admin password for GateFlow.
...
console.log("\n🔑 GateFlow — Password Reset\n");

async function main() {
  // Check if database exists
  if (!existsSync(DB_PATH)) {
    console.error(`❌ Database not found at: ${DB_PATH}`);
    console.error(`   Make sure GateFlow has been started at least once.`);
  ...
  console.log("   Restart GateFlow for changes to take effect.\n");
}
