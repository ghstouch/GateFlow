 ...
 *
 * Serves the GateFlow A2A Agent Card for discovery by other agents.
...
const BASE_URL = process.env.OMNIROUTE_BASE_URL || "http://localhost:1750";

/**
 * GET /.well-known/agent.json
 *
 * Returns the GateFlow Agent Card that describes this gateway's
 * capabilities as an A2A agent.
 */
export async function GET() {
  const agentCard = {
    name: "GateFlow AI Gateway",
    description:
