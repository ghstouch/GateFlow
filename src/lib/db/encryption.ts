 ...
 * The PRIMARY key is now derived with a static salt ("GateFlow-field-encryption-v1").
 ...
 * a different derived key than the static salt `"GateFlow-field-encryption-v1"`. When the
...
const KEY_LENGTH = 32;
const PREFIX = "enc:v1:";
const STATIC_SALT = "GateFlow-field-encryption-v1";
