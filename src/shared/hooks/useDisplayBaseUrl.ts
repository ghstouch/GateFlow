...
export const DEFAULT_DISPLAY_BASE_URL = "http://localhost:1750";
 ...
 *   3. DEFAULT_DISPLAY_BASE_URL ("http://localhost:1750") — SSR / first render fallback.
 *
 ...
 * `src/shared/utils/resolveGateFlowBaseUrl.ts` instead.
 */
