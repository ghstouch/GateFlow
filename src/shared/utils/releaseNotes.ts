...
export const NEWS_JSON_URL =
  "https://raw.githubusercontent.com/diegosouzapw/GateFlow/main/news.json";
export const CHANGELOG_RAW_URL =
  "https://raw.githubusercontent.com/diegosouzapw/GateFlow/main/CHANGELOG.md";
export const CHANGELOG_GITHUB_URL =
  "https://github.com/diegosouzapw/GateFlow/blob/main/CHANGELOG.md";
