...
const footerLinks = {
  ...
  resources: [
    ...
    {
      label: "Help Center",
      href: "https://github.com/ghstouch/gateflow/discussions",
      external: true,
    },
  ],
  company: [
    { label: "About", href: "https://github.com/ghstouch/gateflow", external: true },
    { label: "Blog", href: "https://github.com/ghstouch/gateflow/releases", external: true },
    {
      label: "Contact",
      href: "https://github.com/ghstouch/gateflow/issues/new/choose",
      external: true,
    },
