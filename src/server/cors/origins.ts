 ...
 *
 * Source of truth for which browser origins may call GateFlow over CORS.
...
const STANDARD_ALLOW_HEADERS =
  "Content-Type, Authorization, x-api-key, anthropic-version, x-GateFlow-connection, x-internal-test, accept";
